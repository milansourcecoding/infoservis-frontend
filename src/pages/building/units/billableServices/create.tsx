...
export default function UnitBillableServiceCreatePage() {
  ...
  const onSubmit = async (values: any) => {
    try {
      ...
      await axiosInstance.post(`/unit/${unit_id}/billable-service`, data);

      navigate(`/building/${id}/units/${unit_id}`);
    } catch (error) {
